package com.multi.tenants.api.service.impl;

import com.multi.tenants.api.config.SecurityConstant;
...
public class UserServiceImpl implements UserDetailsService {
    ...
    public OAuth2AccessToken getAccessTokenForUser(ClientDetails client, TokenRequest tokenRequest, String password, String phone, AuthorizationServerTokenServices tokenServices) throws GeneralSecurityException, IOException {
        ...
        if(user == null || !Objects.equals(ITzBaseConstant.STATUS_ACTIVE, user.getStatus())){
    ...
    public OAuth2AccessToken getAccessTokenForEmployee(ClientDetails client, TokenRequest tokenRequest, String password, String phone, String serial, AuthorizationServerTokenServices tokenServices) throws GeneralSecurityException, IOException {
        Map<String, String> requestParameters = new HashMap<>();
        ...
        if (user.getKind() != ITzBaseConstant.USER_KIND_EMPLOYEE) {
    ...
    public ITzBaseJwt getAddInfoFromToken() {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (oauthDetails != null) {
                ...
                if (encodedData != null && !encodedData.isEmpty()) {
                    return ITzBaseJwt.decode(encodedData);
                }
                return null;
            }
        }
